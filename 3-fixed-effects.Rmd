...
print(model_pzn_fixest)
```

We cannot reproduce lm_robust as this package only allow HC1 / CR1 aka "stata" in lm_robust. We cannot use HC2/RC2 using sandwich package as `'hatvalues' is not implemented for estimations with fixed-effects.`
